...
public class Quest8_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quest8_);
    ...
    public void nextQuestion(View view) {
        ...
        Intent intentQuestion9 = new Intent(this, Quest9_Activity.class);
    ...
    private void checkPreferences() {
        ...
        RadioButton questans1 = (RadioButton) findViewById(R.id.radioButton1Question8);
        RadioButton questans2 = (RadioButton) findViewById(R.id.radioButton2Question8);
        RadioButton questans3 = (RadioButton) findViewById(R.id.radioButton3Question8);
        RadioButton questans4 = (RadioButton) findViewById(R.id.radioButton4Question8);

        // Open Preferences file
        sharedpreferences = getSharedPreferences(MyPREFERENCES, Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = sharedpreferences.edit();

        int questAns1 = sharedpreferences.getInt(quest8ans1,0);
    ...
    private void savePreferences() {
        ...
        editor.putInt(quest8ans1, ansToSave);
