...
public class Quest3_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quest3_);
        checkPreferences();
    }
    ...
    private void checkPreferences() {
        ...
        RadioButton questans1 = (RadioButton) findViewById(R.id.radioButton1Question3);
        RadioButton questans2 = (RadioButton) findViewById(R.id.radioButton2Question3);
        RadioButton questans3 = (RadioButton) findViewById(R.id.radioButton3Question3);
        RadioButton questans4 = (RadioButton) findViewById(R.id.radioButton4Question3);

        // Open Preferences file
        sharedpreferences = getSharedPreferences(MyPREFERENCES, Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = sharedpreferences.edit();

        int questAns1 = sharedpreferences.getInt(quest3ans1,0);
    ...
    private void savePreferences() {
        ...
        editor.putInt(quest3ans1, ansToSave);
